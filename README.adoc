...
This article shows you how to build a simple blog application with https://jhipster.github.io/[JHipster] 4. At the time of this writing (January 12, 2017), JHipster 4 has not been released.
